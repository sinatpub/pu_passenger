                ...
                child: Column(
                  children: [
                    ...
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        cardBank(ImageAssets.date_time,
                            bankSelected == 1 ? true : false, () {
                          setState(() {
                            bankSelected = 1;
                          });
                        }),
                        cardBank(ImageAssets.date_time,
                            bankSelected == 2 ? true : false, () {
                          setState(() {
                            bankSelected = 2;
                          });
                        }),
                        cardBank(ImageAssets.date_time,
                            bankSelected == 3 ? true : false, () {
                          setState(() {
                            bankSelected = 3;
                          });
                        }),
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
              color: ationSelect == true ? AppColors.red : AppColors.light3),
          boxShadow: const [
            BoxShadow(
              color: Color(0xFFDEDADA),
              spreadRadius: 2,
