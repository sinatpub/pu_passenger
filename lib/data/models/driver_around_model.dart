...
DriverAroundModel driverAroundModelFromJson(String str) => DriverAroundModel.fromJson(json.decode(str));

String driverAroundModelToJson(DriverAroundModel data) => json.encode(data.toJson());

class DriverAroundModel {
    List<Driver>? data;
    bool? status;
    String? message;
    ...
    factory DriverAroundModel.fromJson(Map<String, dynamic> json) => DriverAroundModel(
        data: json["data"] == null ? [] : List<Driver>.from(json["data"]!.map((x) => Driver.fromJson(x))),
        status: json["status"],
...
class Vehicle {
    ...
    factory Vehicle.fromJson(Map<String, dynamic> json) => Vehicle(
        ...
        status: json["status"],
        vehicleImage: json["vehicle_image"] == null ? [] : List<VehicleImage>.from(json["vehicle_image"]!.map((x) => VehicleImage.fromJson(x))),
    );
    ...
    Map<String, dynamic> toJson() => {
        ...
        "status": status,
        "vehicle_image": vehicleImage == null ? [] : List<dynamic>.from(vehicleImage!.map((x) => x.toJson())),
    };
}
